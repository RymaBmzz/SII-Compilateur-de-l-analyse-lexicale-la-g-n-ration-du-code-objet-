...
public interface TinyListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link TinyParser#x}.
	 * @param ctx the parse tree
	 */
	void enterX(TinyParser.XContext ctx);
	/**
	 * Exit a parse tree produced by {@link TinyParser#x}.
	 * @param ctx the parse tree
	 */
	void exitX(TinyParser.XContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link TinyParser#oprt4}.
	 * @param ctx the parse tree
	 */
	void enterOprt4(TinyParser.Oprt4Context ctx);
	/**
	 * Exit a parse tree produced by {@link TinyParser#oprt4}.
	 * @param ctx the parse tree
	 */
	void exitOprt4(TinyParser.Oprt4Context ctx);
	/**
